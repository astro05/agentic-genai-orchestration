...
using OllamaSharp;
using TextGeneration_Ollama.Models;


// Create a client with the base URL of the Ollama server and the model name you want to use. Make sure the Ollama server is running in the docker and the specified model is available.
IChatClient client =
