...
var githubModel = "gpt-4o-mini";
var credential = new ApiKeyCredential(builder.Configuration[githubToken] ?? throw new InvalidOperationException($"Missing configuration: {githubToken}. See the README for details."));
...
var chatClient = ghModelsClient.GetChatClient(githubModel).AsIChatClient();
